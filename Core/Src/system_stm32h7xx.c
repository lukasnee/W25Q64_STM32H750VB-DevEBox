...
/* FPU settings ------------------------------------------------------------*/
    ...
    /* Reset HSEON, HSECSSON, CSION, HSI48ON, CSIKERON, PLL1ON, PLL2ON and
     * PLL3ON bits */
    RCC->CR &= 0xEAF6ED7FU;
 ...
 *         (**) HSI_VALUE is a constant defined in stm32h7xx_hal.h file (default
 * value 64 MHz) but the real value may vary depending on the variations in
 * voltage and temperature.
 *
 *         (***)HSE_VALUE is a constant defined in stm32h7xx_hal.h file (default
 * value 25 MHz), user has to ensure that HSE_VALUE is same as the real
        ...
        */
        ...
        fracn1 =
            (float_t)(uint32_t)(pllfracen *
                                ((RCC->PLL1FRACR & RCC_PLL1FRACR_FRACN1) >> 3));
